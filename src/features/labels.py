...
DEFINITION LOCKED (v1):
- Return Type: Split-adjusted close price return (no dividends in v1)
- Source: FMP /stable/historical-price-eod/full (already split-adjusted)
- TODO v2: Add dividend-adjusted total returns
...
class ForwardReturn:
    ...
    stock_return: float        # (P_T+H / P_T) - 1
    benchmark_return: float    # (P_b,T+H / P_b,T) - 1
    excess_return: float       # stock_return - benchmark_return
    ...
    label_matured_at: datetime  # UTC datetime when label became "known"
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "ForwardReturn":
        ...
        return cls(
            ...
            benchmark_entry_price=d["benchmark_entry_price"],
            benchmark_exit_price=d["benchmark_exit_price"],
